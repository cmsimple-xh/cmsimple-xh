<?php
$tpl_tx['text']['sitename_logobox']="<a href=\"./\" title=\"Home\"><img src='" . $pth['folder']['templateimages'] . "logo_en.png' alt='Logo'></a>";
...
$tpl_tx['text']['pagetools_to-top']="Upwards";
$tpl_tx['text']['footer_company-name']="Company";

 // Config languagemenu (select the display of the language menu)
$cf['language']['menu']="dd_flagsandlongname"; // Options: flags|shortname|longname|flagsandshortname|flagsandlongname|dd_longname|dd_flagsandlongname (dd_=Dropdownmenu)
