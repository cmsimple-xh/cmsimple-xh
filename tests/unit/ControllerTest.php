...
/**
 * Testing the handling of password check requests.
 *
 * @category Testing
 * @package  XH
 * @author   The CMSimple_XH developers <devs@cmsimple-xh.org>
 ...
 * @since    1.6.3
 */
class ControllerPasswordCheckTest extends PHPUnit_Framework_TestCase
{
    /**
     * The test subject.
     *
     ...
     * @retun void
     */
    public function testSentsContentTypeHeader()
    {
        $this->headerMock->expects($this->any())->with('Content-Type: text/plain');
        $this->handlePasswordCheck();
    }

    /**
     * Tests that 1 is output for valid passwords.
     *
     * @return void
     *
     * @global PasswordHash The password hasher.
     */
    public function testOutputs1ForValidPassword()
    {
        global $xh_hasher;
    ...
    /**
     * Tests that 0 is output for invalid passwords.
     *
     * @return void
     *
     * @global PasswordHash The password hasher.
     */
    public function testOutputs0ForInvalidPassword()
    {
        global $xh_hasher;
     ...
     * @return void
     */
    protected function handlePasswordCheck()
    {
        ob_start();
        $this->subject->handlePasswordCheck();
        ob_end_clean();
