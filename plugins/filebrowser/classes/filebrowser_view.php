            ...
            foreach ($folders as $folder) {
                ...
                $html .= '<li class="folder">
                              <form style="display: inline;" method="POST" action="" onsubmit="return confirmFolderDelete(\'' . $this->translate('confirm_delete', $this->basePath . $folder) . '\');">
                                ' . tag('input type="image" src="' . $this->browserPath . 'css/icons/delete.png" alt="delete" title="' . $this->translate('delete_folder') . '"') . '
    ...
    function subfolderListForEditor($folders) {
        ...
        if (is_array($folders) && count($folders) > 0) {
            ...
            foreach ($folders as $folder) {
                ...
                $html .= '<li class="folder">
                              <form style="display: inline;" method="POST" action="" onsubmit="return confirmFolderDelete(\'' . $this->translate('confirm_delete', $this->basePath . $folder) . '\');">
                                <input type="image" src="' . $this->browserPath . 'css/icons/delete.png" alt="delete" title="' . $this->translate('delete_folder') . '" />
            ...
            $html .= '
                <li style="white-space:nowrap;" class="' . $class . '">
                    <form style="display: inline;" method="POST" action="" onsubmit="return confirmFileDelete(\'' . $this->translate('confirm_delete', $this->currentDirectory . $file) . '\');">
                        ' . tag('input type="image" src="' . $this->browserPath . 'css/icons/delete.png" alt="delete" title="' . $this->translate('delete_file') . '" style="width: 16px; height: 16px"') . '
                    ...
                    <a style="position:relative" href="#" id="file_' . $i . '" onclick="showRenameForm(\'' . $i . '\', \'' . $this->translate('prompt_rename', $file) . '\');">' . tag('img src="' . $this->browserPath . 'css/icons/rename.png" alt="' . $this->translate('rename_file') . '" title="' . $this->translate('rename_file') . '" style="width: 16px; height: 16px"') . '</a>
