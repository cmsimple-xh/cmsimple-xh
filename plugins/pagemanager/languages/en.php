<?php
	...
	$plugin_tx['pagemanager']['cf_verbose']="<p>Show information and confirmation dialogs? <em>YES</em> or <em>NO</em></p><p><strong><em>YES</em> is strongly recommended</strong>, unless you are a power user <strong>and</strong> are accustomed to Pagemanager_XH.</p>";
	$plugin_tx['pagemanager']['cf_toolbar_show']="<p>Sould the toolbar be shown? <em>YES</em> or <em>NO</em></p>";
	$plugin_tx['pagemanager']['cf_toolbar_vertical']="<p>Should the toolbar be displayed vertically? <em>YES</em> or <em>NO</em></p><p>This option is for power users, who can adjust the layout in Plugin Stylesheet.</p>";
	$plugin_tx['pagemanager']['cf_pagedata_attribute']="<p>The yes/no (with default yes) pagedata attribute for the checkboxes, e.g. <em>published</em> or <em>linked_to_menu</em>.</p><p><strong>Caution:</strong> If you choose an inappropriate attribute, you will mess up your pagedata.php!</p>";
	$plugin_tx['pagemanager']['cf_treeview_theme']="<p>Theme of tree view widget: <em>cmsimple</em></p><p>Other themes are available from http://3-magi.net/?CMSimple_XH/Pagemanager_XH.</p>";
	$plugin_tx['pagemanager']['cf_treeview_animation']="<p>Duration of open/close animations in ms. <em>0</em> means no animation.</p>";
	...
	$plugin_tx['pagemanager']['op_create']="Create page (<em>as sub-page</em>)";
	$plugin_tx['pagemanager']['op_create_after']="Create page (<em>on same level - after sub-pages</em>)";
	$plugin_tx['pagemanager']['op_rename']="Rename page";
	$plugin_tx['pagemanager']['op_delete']="Delete page (<em>incl. sub-pages</em>)";
	$plugin_tx['pagemanager']['op_cut']="Cut";
	$plugin_tx['pagemanager']['op_copy']="Copy";
	$plugin_tx['pagemanager']['op_paste']="Paste (<em>as sub-page</em>)";
	$plugin_tx['pagemanager']['op_paste_after']="Paste (<em>on same level - after sub-pages</em>)";
	$plugin_tx['pagemanager']['op_help']="<p>You can rearrange pages by <em>drag&amp;drop</em>. <em>Right clicking on a page</em> opens the context menu. More detailed instruction are available in the plugin help.</p>";
	...
	$plugin_tx['pagemanager']['error_phpversion']="Pagemanager_XH requires at least PHP version 4.3.0!";
