...
$plugin_tx['pagemanager']['op_help']="<p>You can rearrange pages by <em>drag&amp;drop</em>. <em>Right clicking on a page</em> opens the context menu. More detailed instruction are available in the plugin help, which is available by clicking this help icon.</p>";
