{
    ...
    language : "%LANGUAGE%",
    plugins : "pagebreak,style,layer,table,save,advimage,advlink,advhr,emotions,iespell,"
    ...
    */
    // Theme options
    theme_advanced_buttons1 : "autosave,save,|,fullscreen,code,formatselect,fontsizeselect,styleselect",
    theme_advanced_buttons2 : "bold,italic,|,justifyleft,justifycenter,justifyright,justifyfull,outdent,indent,blockquote,hr,removeformat,|,bullist,numlist,|,charmap,",
    theme_advanced_buttons3 : "image,link,unlink,|,tablecontrols",
...
//    entity_encoding : "'.$plugin_cf['tinymce']['entity_encoding'].'",
    ...
    theme_advanced_buttons2 : "link,unlink,anchor,image,meida,cleanup,|,hr,removeformat,visualaid,|,forecolor,backcolor,|,search,replace,|,charmap,emotions,|,sub,sup,tablecontrols,insertdate,inserttime,|,help",
