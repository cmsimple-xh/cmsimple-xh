<?php
	...
	$plugin_tx['page_params']['hint_published']="<p>Legen Sie hier fest, ob Sie diese Seite (schon) Ihren Besuchern präsentieren wollen.</p>";
  	$plugin_tx['page_params']['hint_linked_to_menu']="<p>Wenn eine Seite - beispielsweise eine Newsbox - nicht im Navigationsmenü angezeigt werden soll, wählen Sie <b>Nein</b>.</p>";
	$plugin_tx['page_params']['hint_last_edit']="<p>Sie können das Datum der letzten Bearbeitung anzeigen lassen.</p><p>Das Datumsformat legen Sie über die CMSimple-Spracheinstellungen fest, das sonstige Erscheinungsbild über css (#pp_last_update).</p>";
	$plugin_tx['page_params']['hint_template']="<p>Hier können Sie für diese Seite ein vom Standard abweichendes Template auswählen.</p>";
