...
/* utf8-marker = äöüß */
  ...
  $plugin_tx['page_params']['hint_linked_to_menu']="<p>Choose \"No\" to hide this page from the navigation.</p><p>The page content will still be available for newsboxes and direct links.</p>";  
	$plugin_tx['page_params']['hint_last_edit']='<p>Choose "yes" to display the date of the last edit of this very page. The Date format can be changed in the language settings, the look can be styled with the CSS-class "#pp_last_update".</p>';
