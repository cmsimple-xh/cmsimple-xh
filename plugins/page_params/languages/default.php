<?php
	...
	$plugin_tx['page_params']['hint_published']="<p>If you choose <b>no</b> this page will be hidden from your visitors. Do not forget to change it to <b>yes</b> when you are ready.</p>";
  $plugin_tx['page_params']['hint_linked_to_menu']="<p>Choose <b>No</b> to hide this page from the navigation.</p><p>The page content will still be available for newsboxes and direct links.</p>";
	$plugin_tx['page_params']['hint_last_edit']="<p>Choose <b>yes</b> to display the date of the last edit of this very page. The Date format can be changed in the language settings, the look can be styled with the CSS selector <b>#pp_last_update</b>.</p>";
	...
	$plugin_tx['page_params']['utf-8_marker']="æøå";
	
	//added by simpleSolutions	
	...
	$plugin_tx['page_params']['hint_publication_period']="<p>You can specify the publication period by specifying the release and expirations dates. The date is GMT time and can be adjusted at any time zome + / - 12 hours page_params language file.</p><p>Date Format is: yyyy-m-d [h: m].</p><p>If the release date is set, the site will only be published when the publication date has passed.</p></p><p>If the expiration date is specified the page will be hidden after the expiration date has passed. Both fields may be left empty.</p><p>Published must be set to \"yes\"</p>";
?>