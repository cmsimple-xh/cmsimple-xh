 ...
 * @copyright 2009-2019 The CMSimple_XH developers
...
(function () {
    ...
    function onLinked_to_menuClick(event) {
        var target = event.target;

        toggle(target.form.elements.header_status);
        target.form.elements.header_status.value = "";
    }
    ...
    on(window, "load", function () {
        ...
        if (form) {
            ...
            on(elements.linked_to_menu[1], "click", onLinked_to_menuClick);
