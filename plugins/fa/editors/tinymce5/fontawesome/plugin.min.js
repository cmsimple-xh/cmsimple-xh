...
tinymce.PluginManager.add('fontawesome', function (editor, url) {
    ...
    $('.mce-fontawesome-panel-accordion').closest('[role="dialog"').addClass('mce-fontawesome-panel');
		...
		function insertIcon() {
			...
			var content = '<span class="mceNonEditable fa fa-' + id + '"></span>';
...
/*		firstAccordion.classList.add('mce-fontawesome-panel-accordion-open');   // dont know how to set focus on top left EM/18.01.2019
...
*/    
  ...
  editor.ui.registry.addIcon('binoculars', '<svg width="16" height="16"><use xlink:href="' + url + '/symbol-defs.svg#icon-binoculars"></use></svg>');
