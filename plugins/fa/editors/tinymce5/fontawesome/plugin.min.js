...
+groupHtml('accessibilityIcons',translate('Accessibility'))
+'<p class="mce-fontawesome-search-noresults" style="display: none;">'+translate('No icons matched your search')+'.</p>'
+'</div>';win=editor.windowManager.open({title:translate('Icons'),size:'large',body:{type:"panel",items:[{type:"htmlpanel",html:panelHtml}]},buttons:[{type:'custom',name:'close',text:translate('Close')}],onAction:function(dialogApi,actionData){if(actionData.name==='close'){win.close();}}});function insertIcon(){var id=this.getAttribute('data-id');if(this.hasAttribute('data-spin')){id+=' fa-spin';}
var content='<span class="fa fa-'+id+'"></span>';if(editor.selection.getNode().textContent===''){content+='&nbsp;';}
editor.execCommand('mceInsertContent',false,content);win.close();}
var iconInserts=document.querySelectorAll('.js-mce-fontawesome-insert');for(var i=0;i<iconInserts.length;i++){iconInserts[i].addEventListener('click',insertIcon);}
var accordionItems=document.querySelectorAll('.mce-fontawesome-panel-accordion');var accordionTitle;var accordionContent;for(i=0;i<accordionItems.length;i++){accordionTitle=accordionItems[i].querySelector('.mce-fontawesome-panel-title');accordionTitle.addEventListener('click',toggleItem);accordionContent=accordionItems[i].querySelector('.mce-fontawesome-panel-content');accordionContent.style.height='0';}
var firstAccordion=document.querySelector('.mce-fontawesome-panel-accordion');firstAccordion.classList.add('mce-fontawesome-panel-accordion-open');var firstAccordionContent=firstAccordion.querySelector('.mce-fontawesome-panel-content');firstAccordionContent.style.height='auto';var nextHeight=Math.ceil(firstAccordionContent.offsetHeight);firstAccordionContent.style.height=nextHeight+'px';firstAccordionContent.style.transitionDuration=transitionCalc(nextHeight);setTimeout(function(){document.querySelector(".mce-fontawesome-panel").style.height=document.querySelector(".tox-form").clientHeight+"px";},0);function toggleItem(){if(document.querySelector('.mce-fontawesome-panel-search')){return;}
var accordionItem=this.parentNode;var open=false;if(accordionItem.classList.contains('mce-fontawesome-panel-accordion-open')){open=true;}
var accordionPanel;for(var i=0;i<accordionItems.length;i++){accordionItems[i].classList.remove('mce-fontawesome-panel-accordion-open');accordionPanel=accordionItems[i].querySelector('.mce-fontawesome-panel-content');accordionPanel.style.height='0';}
if(!open){var accordionItemContent=accordionItem.querySelector('.mce-fontawesome-panel-content');accordionItemContent.style.height='auto';var nextHeight=Math.ceil(accordionItemContent.offsetHeight);accordionItemContent.style.height='0';accordionItem.classList.add('mce-fontawesome-panel-accordion-open');accordionItemContent.style.transitionDuration=transitionCalc(nextHeight);window.getComputedStyle(accordionItemContent).opacity;accordionItemContent.style.height=nextHeight+'px';}}
function transitionCalc(length){var result=length / 300;if(result>.8){result=.8;}
if(result<.3){result=.3;}
return result+'s';}
var foot=document.querySelector('.tox-dialog-wrap .tox-dialog__footer');var searchContainer=document.createElement('div');searchContainer.className='mce-fontawesome-search-container';searchContainer.innerHTML='<input type="search" placeholder="'+translate('Search')+'"><div class="mce-fontawesome-search-container-clear"><span class="fa fa-times-circle"></span></div>';foot.insertBefore(searchContainer,foot.firstChild);var searchInput=searchContainer.querySelector('input');searchInput.addEventListener('input',search);function search(){var categoryList=document.querySelectorAll('.mce-fontawesome-panel-accordion');var categoryContentList=document.querySelectorAll('.mce-fontawesome-panel-content');var iconList=document.querySelectorAll('.js-mce-fontawesome-insert');var searchTerm=this.value.toLowerCase().replace(' ','-');var i;var hiddenCategories=0;if(this.value.length){document.querySelector('.mce-fontawesome-panel').classList.add('mce-fontawesome-panel-search');for(i=0;i<iconList.length;i++){hideOrShowIcon(searchTerm,iconList[i]);}
for(i=0;i<categoryList.length;i++){categoryList[i].classList.add('mce-fontawesome-panel-accordion-open');if(categoryList[i].querySelector('.js-mce-fontawesome-insert:not(.js-mce-fontawesome-insert-hidden)')){categoryList[i].style.display='';}else{categoryList[i].style.display='none';hiddenCategories++;}}
for(i=0;i<categoryContentList.length;i++){categoryContentList[i].style.height='auto';}
if(hiddenCategories===categoryList.length){document.querySelector('.mce-fontawesome-search-noresults').style.display='block';}else{document.querySelector('.mce-fontawesome-search-noresults').style.display='none';}}else{document.querySelector('.mce-fontawesome-panel').classList.remove('mce-fontawesome-panel-search');document.querySelector('.mce-fontawesome-search-noresults').style.display='none';for(i=0;i<iconList.length;i++){iconList[i].classList.remove('js-mce-fontawesome-insert-hidden');iconList[i].style.display='';}
for(i=0;i<categoryList.length;i++){categoryList[i].classList.remove('mce-fontawesome-panel-accordion-open');categoryList[i].style.display='';}
for(i=0;i<categoryContentList.length;i++){categoryContentList[i].style.height='0';}}}
function hideOrShowIcon(search,iconElement){var id=iconElement.getAttribute('data-id');if(strInStr(search,id)){iconElement.classList.remove('js-mce-fontawesome-insert-hidden');iconElement.style.display='';return;}
for(var i=0;i<iconList.length;i++){if(iconList[i].id===id){if(iconList[i].filter){for(var ii=0;ii<iconList[i].filter.length;ii++){if(strInStr(search,iconList[i].filter[ii])){iconElement.classList.remove('js-mce-fontawesome-insert-hidden');iconElement.style.display='';return;}}}
iconElement.classList.add('js-mce-fontawesome-insert-hidden');iconElement.style.display='none';}}}
function strInStr(needle,haystack){return haystack.indexOf(needle)>-1;}
searchInput.focus();document.querySelector('.mce-fontawesome-search-container-clear').addEventListener('click',function(){searchInput.value='';search.call(searchInput);searchInput.focus();});}
editor.ui.registry.addIcon('fort-awesome','<svg width="16" height="16"><use href="'+url+'/fort-awesome-brands.svg#fort-awesome"></use></svg>');editor.on('init',function(){var csslink=editor.dom.create('link',{rel:'stylesheet',href:url+'/css/fontawesome.min.css'});document.getElementsByTagName('head')[0].appendChild(csslink);});editor.ui.registry.addMenuItem('fontawesome',{text:'Font Awesome',tooltip:'Font Awesome',icon:'fort-awesome',context:'tools',onAction:function(){showDialog();}});editor.ui.registry.addButton('fontawesome',{tooltip:'Font Awesome',icon:'fort-awesome',onAction:function(){showDialog();}});return{getMetadata:function(){return{name:"Font Awesome",url:"https://github.com/cmb69/fa_xh/releases/latest"};}};});