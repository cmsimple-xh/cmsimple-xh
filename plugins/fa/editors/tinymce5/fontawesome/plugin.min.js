...
editor.ui.registry.addIcon('binoculars','<svg width="16" height="16"><use xlink:href="'+url+'/symbol-defs.svg#icon-binoculars"></use></svg>');editor.on('init',function(){var csslink=editor.dom.create('link',{rel:'stylesheet',href:url+'/css/fontawesome.min.css'});document.getElementsByTagName('head')[0].appendChild(csslink);});editor.ui.registry.addMenuItem('fontawesome',{text:'Font Awesome',tooltip:'Font Awesome',icon:'binoculars',context:'tools',onAction:function(){showDialog();}});editor.ui.registry.addButton('fontawesome',{tooltip:'Font Awesome',icon:'binoculars',onAction:function(){showDialog();}});return{getMetadata:function(){return{name:"Font Awesome",url:"https://github.com/cmb69/fa_xh/releases/latest"};}};});