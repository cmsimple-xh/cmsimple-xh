...
editor.on('init',function(){var csslink=editor.dom.create('link',{rel:'stylesheet',href:url+'/css/fontawesome.min.css'});document.getElementsByTagName('head')[0].appendChild(csslink);});editor.addButton('fontawesome',{icon:'flag',text:translate('Icons'),tooltip:translate('Icons'),onclick:showDialog});editor.addMenuItem('fontawesome',{icon:'flag',text:translate('Icons'),onclick:showDialog,context:'insert'});});