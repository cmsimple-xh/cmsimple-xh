...
var win;var width=23;var panelHtml=groupHtml('webApplicationIcons',translate('Web Application'))
...
+'<p class="mce-fontawesome-search-noresults" style="display: none;">'+translate('No icons matched your search')+'.</p>';win=editor.windowManager.open({autoScroll:true,width:690,height:500,title:translate('Icons'),spacing:20,padding:10,classes:'fontawesome-panel',items:[{type:'container',html:panelHtml}],buttons:[{text:translate('Close'),onclick:function(){win.close();}}]});function insertIcon(){var id=this.getAttribute('data-id');if(this.hasAttribute('data-spin')){id+=' fa-spin';}
...
var firstAccordion=document.querySelector('.mce-fontawesome-panel-accordion');firstAccordion.classList.add('mce-fontawesome-panel-accordion-open');var firstAccordionContent=firstAccordion.querySelector('.mce-fontawesome-panel-content');firstAccordionContent.style.height='auto';var nextHeight=Math.ceil(firstAccordionContent.offsetHeight);firstAccordionContent.style.height=nextHeight+'px';firstAccordionContent.style.transitionDuration=transitionCalc(nextHeight);function toggleItem(){if(document.querySelector('.mce-fontawesome-panel-search')){return;}
...
editor.on('init',function(){var csslink=editor.dom.create('link',{rel:'stylesheet',href:url+'/css/fontawesome.min.css'});document.getElementsByTagName('head')[0].appendChild(csslink);});editor.addButton('fontawesome',{image:tinymce.baseURL+'/../../fa/editors/tinymce4/fontawesome/fontawesome.png',tooltip:'Font Awesome',onclick:showDialog});editor.addMenuItem('fontawesome',{image:tinymce.baseURL+'/../../fa/editors/tinymce4/fontawesome/fontawesome.png',onclick:showDialog,context:'insert'});});