...
editor.on('init',function(){var csslink=editor.dom.create('link',{rel:'stylesheet',href:url+'/css/fontawesome.min.css'});document.getElementsByTagName('head')[0].appendChild(csslink);});editor.addButton('fontawesome',{image:url+'/fontawesome.png',tooltip:'Font Awesome',onclick:showDialog});editor.addMenuItem('fontawesome',{image:url+'/fontawesome.png',onclick:showDialog,context:'insert'});});