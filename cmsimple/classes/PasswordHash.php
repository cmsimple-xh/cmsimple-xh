...
class PasswordHash
{
     ...
     *
     * @param int  $iterationCountLog2 An iteration count.
     * @param bool $portableHashes     Whether to create portable hashes.
     */
    public function __construct($iterationCountLog2, $portableHashes)
    {
        $this->itoa64 = './0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'
    ...
    /**
     * Returns some kind of base64 encoded string.
     *
    ...
    /**
     * Generates and returns a private salt.
     *
     * @param string $input An input string.
     *
     * @return string
    ...
    /**
     * Generates and returns the actual password hash.
     *
    ...
    /**
     * Generates and returns an extended salt.
     *
     * @param string $input An input string.
     *
     * @return string
    ...
    /**
     * Generates and returns a blowfish compatible salt.
     *
     * @param string $input An input string.
     *
     * @return string
    ...
    /**
     * Returns whether a hash matches a certain password.
     *
     * @param string $password    A password
     * @param string $stored_hash A stored password hash.
     *
     * @return bool
     */
