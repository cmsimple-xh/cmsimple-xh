...
$tx['help']['site_compat']="Does the website require functions that have been removed as of CMSimple_XH 1.7?<br>These functions output an XH-DEPRECATED message in debug mode.<br>If there is no such message, this setting can be deactivated.";
