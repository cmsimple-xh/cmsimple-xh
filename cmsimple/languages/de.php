...
$tx['action']['ok']="OK";
$tx['action']['restore']="wiederherstellen";
...
$tx['error']['fatal']="Ein fataler Fehler ist aufgetreten. Aktivieren Sie den <a href=\"https://wiki.cmsimple-xh.org/de/?tipps-und-tricks/fehlersuche-debug-modus\" target=\"_blank\">Debug-Modus</a> für weitere Hinweise.";
...
$tx['help']['site_compat']="Benötigt die Website Funktionen, die ab CMSimple_XH 1.7 entfernt wurden?<br>Diese Funktionen geben eine XH-DEPRECATED-Meldung im Debug-Mode aus.<br>Wenn es keine solche Meldung gibt, kann diese Einstellung deaktiviert werden.";
...
$tx['help']['search_title']="Zeigt den Seitentitel in den Suchergebnissen an.<br>Es muss ein expliziter Seitentitel für die Seite angelegt sein.";
...
$tx['link']['int_error_fragment']="Fehlerhafter interner Link, Anker existiert nicht.";
$tx['link']['link']="Link: ";
...
$tx['message']['restored']="Sicherungsdatei erfolgreich wieder zur Content-Datei gemacht.";
...
$tx['pagedata']['deleted_1']="%s Page-Data Feld wurde gelöscht.";
$tx['pagedata']['deleted_2_4']="%s Page-Data Felder wurden gelöscht.";
$tx['pagedata']['deleted_5']="%s Page-Data Felder wurden gelöscht.";
...
$tx['password_forgotten']['email1_text']="Sie haben das Zurücksetzen Ihres Passworts angefordert. Klicken Sie den folgenden Link an, um Ihr Passwort zurückzusetzen.:";
$tx['password_forgotten']['email2_sent']="Das Passwort wurde zurückgesetzt. Eine E-Mail mit dem neuen Passwort wurde an die hinterlegte Adresse versandt.";
$tx['password_forgotten']['email2_text']="Ihr Passwort wurde zurück gesetzt. Ihr neues Passwort ist:";
$tx['password_forgotten']['request']="Bestätigen Sie die hinterlegte E-Mail-Adresse um Anweisungen anzufordern, wie Sie das Passwort zurück setzen.";
