...
$tx['help']['site_timezone']="Eine <a href=\"http://www.php.net/manual/de/timezones.php\">Zeitzone</a>, die die Einstellung des Servers überschreibt. Funktioniert nur ab PHP 5.1.0.";
...
$tx['pagedata']['nothing']="Es musste nichts getan werden.";
$tx['pagedata']['ok']="Die Page-Data enthalten keinen potentiellen Müll.";

$tx['password']['change']="Kennwort ändern";
$tx['password']['confirmation']="Bestätigung";
$tx['password']['fields_missing']="Alle Felder ausfüllen.";
$tx['password']['invalid']="Das neue Kennwort ist ungültig.";
$tx['password']['mismatch']="Das neue Kennwort stimmt nicht mit der Bestätigung überein.";
