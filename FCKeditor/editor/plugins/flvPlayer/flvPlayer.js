...
Media.prototype.getInnerHTML = function (objectId){
	var s = "";
	//old code: s+= '<object type="application/x-shockwave-flash" border="1" width="' + this.width + '" height="' + this.height + '" data="player.swf?file=' + this.url + '&amp;image=' + this.iurl + '&amp;backcolor=' + this.toolcolor + '&amp;frontcolor=' + this.tooltcolor + '&amp;lightcolor=' + this.tooltrcolor + '&amp;screencolor=' + this.bgcolor + '&amp;repeat=' + this.loop + '&amp;autostart=' + this.play + '"><param name="movie" value="player.swf?file=' + this.url + '&amp;image=' + this.iurl + '&amp;backcolor=' + this.toolcolor + '&amp;frontcolor=' + this.tooltcolor + '&amp;lightcolor=' + this.tooltrcolor + '&amp;screencolor=' + this.bgcolor + '&amp;repeat=' + this.loop + '&amp;autostart=' + this.play + '"></object>';
	
	s+= '<object id="flowplayer" border="1" width="' + this.width + '" height="' + this.height + '" data="FCKeditor/editor/plugins/flvPlayer/flowplayer.swf" type="application/x-shockwave-flash"><param name="movie" value="FCKeditor/editor/plugins/flvPlayer/flowplayer.swf" /><param name="allowfullscreen" value="true" /><param name="bgcolor" value="' + this.bgcolor + '" /><param name="flashvars" value=\'config={"clip":{"url":"' + this.url + '", "autoPlay":' + this.play + '},"plugins":{"controls":{"autoHide":"always","stop":true,"mute":false,"height":18,"backgroundColor":"#' + this.toolcolor + '","backgroundGradient":"high","bufferColor":"#000000","progressColor":"#000000","progressGradient":"none","buttonColor":"#000000","buttonOverColor":"#' + this.tooltrcolor + '","timeColor":"#ffffff","durationColor":"#99cccc","opacity":0.7,"borderRadius":6,"tooltipColor":"#' + this.tooltcolor + '","tooltips":{"buttons":true}}}}\' /></object>';
	//playlist splash, not working: s+= '<object id="flowplayer" border="1" width="' + this.width + '" height="' + this.height + '" data="FCKeditor/editor/plugins/flvPlayer/flowplayer.swf" type="application/x-shockwave-flash"><param name="movie" value="FCKeditor/editor/plugins/flvPlayer/flowplayer.swf" /><param name="allowfullscreen" value="true" /><param name="bgcolor" value="' + this.bgcolor + '" /><param name="flashvars" value=\'config={"playlist":["url":"' + this.iurl + '",{"url":"' + this.url + '", "autoPlay":' + this.play + ', "autoBuffering"=true}],"plugins":{"controls":{"autoHide":"always","stop":true,"mute":false,"height":18,"backgroundColor":"#' + this.toolcolor + '","backgroundGradient":"high","bufferColor":"#000000","progressColor":"#000000","progressGradient":"none","buttonColor":"#000000","buttonOverColor":"#' + this.tooltrcolor + '","timeColor":"#ffffff","durationColor":"#99cccc","opacity":0.7,"borderRadius":6,"tooltipColor":"#' + this.tooltcolor + '","tooltips":{"buttons":true}}}}\' /></object>';
	s=s.replace(/#/g,"");
